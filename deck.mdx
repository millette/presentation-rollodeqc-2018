...
Gatsby offre un API riche pour construire des greffons à différents stages de la construction d'un site.
...
[EN] *A transformer plugin converts data from one format (e.g. CSV, YAML) to a JavaScript object*
...
Dans le cadre du RoLLodeQc, j'ai écrit le script ghraphql pour faire
les requêtes à GitHub puisque ce dernier limite, selon la complexité, le nombre de résultats par requêtes.
