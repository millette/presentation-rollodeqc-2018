...
* En général, on utilise npm (ou yarn) pour installer les dépendances d'un projet, localement
* On peut aussi utiliser npm globalement pour installer des outils à la ligne de commande, mais c'est plus rare
* Quand on fait une installation globale, les fichiers iront dans un espace global de l'intallation nodeJS,
  soit au niveau du système ou au niveau de l'utilisateur
* C'est préférable que les installations dites globales se fassent au niveau de l'utilisateur
* D'où la suggestion d'utiliser un gestionnaire de versions pour installer nodeJS
